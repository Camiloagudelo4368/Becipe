...
var searchRecipe = function () {
    ...
    if (allowedIngredients.length === 0) {
        ...
        if (isBrowser) {
            urlAPI =  "https://api.yummly.com/v1/api/recipes?_app_id=ab4906ff&_app_key=25c71a2c8b446d9ef17b082ae3451972&requirePictures=true&q=" + lastOnArray(allowedIngredients)
            $("#isBrowser").text("Mobile device");
        }
        else{
            urlAPI =  "https://api.yummly.com/v1/api/recipes?_app_id=ab4906ff&_app_key=25c71a2c8b446d9ef17b082ae3451972&requirePictures=true&q=" + lastOnArray(allowedIngredients) + allowedIngredientsUrl + excludedIngredientsUrl
